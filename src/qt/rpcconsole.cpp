...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the BlackHatCoin RPC console.") + "<br>" +
...
{
    QScrollBHC *scrollBHC = ui->messagesWidget->verticalScrollBHC();
    scrollBHC->setValue(scrollBHC->maximum());
}
